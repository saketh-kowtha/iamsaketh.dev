...
export default function ProjectCard({ project }) {
  ...
  return (
    <>
      <article
        className="group card ornate-border transition-all duration-300 hover:scale-[1.02]"
        onMouseEnter={() => playSound("hover", 0.1)}
      >
        <div className="p-5">
          <div className="flex items-center gap-3 mb-3">
            <h3 className="text-xl text-primary font-bold group-hover:text-accent transition-colors">
              {project.name}
            </h3>
